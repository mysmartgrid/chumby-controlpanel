...
set(URL "https://github.com/mysmartgrid/chumby-controlpanel.git")
...
configure_ctest_config(${KDE_CTEST_VCS_REPOSITORY} "CTestConfig.cmake")
kde_ctest_setup()
...
set(ASOUND_HOME /opt/arm-2008q3/)
set(LIBTS_HOME /opt/arm-2008q3/)
set(ATOMIX_HOME /opt/arm-2008q3/)
set(NEPTUNE_HOME /opt/arm-2008q3/)
set(BLUETUNE_HOME /opt/arm-2008q3/)
...
if( NOT ${build_res} AND ${CTEST_PUSH_PACKAGES})
  ...
  set(_package_file "${CPACK_PACKAGE_FILE_NAME}.tar.gz")

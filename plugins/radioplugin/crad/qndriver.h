...
#define COUNTRY_ITALY 			4
#define COUNTRY_UNKNOWN			127
/************************EDN******************************/
...
extern int get_ch_start_for_country(int country);
extern int get_ch_stop_for_country(int country);
extern int get_ch_step_for_country(int country);
